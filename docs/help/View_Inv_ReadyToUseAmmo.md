...
![](images/View_LoadedAmmo_menu.jpg)

![](images/View_LoadedAmmo_List.jpg)
...
![](images/View_LoadedAmmo_Toolbar.jpg)
...
To Export the "Ready to Use" Ammunition, just click on the 1st icon on the left ( ![](images/Backup_database.jpg)  ) and the following window will appear:

![](images/View_LoadedAmmo_Export.jpg)
