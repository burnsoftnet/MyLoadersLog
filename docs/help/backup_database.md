...
To backup a database to a disk while in the program, click on picture of an open folder ( ![](images/Winxpicons_Disk_2_32x32.jpg) ).  This will close out the "My Loaders Log" program and bring up the following window:
