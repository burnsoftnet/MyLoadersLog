...
To Import a database that you have on Disk while in the program, click on picture of an open folder ( ![](images/Winxpicons_Folder_10_32x32.jpg) ).  This will close out the "My Loaders Log" program and bring up the following window.
