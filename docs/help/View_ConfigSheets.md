...
![](images/View_Config_SideList.jpg)
...
![](images/View_Config_SideList_ByCaliber.jpg)

## The Tool Bar

![](images/View_Config_ToolBar.jpg)
...
Once you click  on the Ammo Plus icon ( ![](images/add_am~1.gif) ) the following window will appear:

![](images/View_Config_Load-n-Make_Ready.jpg)
...
When viewing a Configuration just click on the Paper World Icon on the Tool bar ( ![](images/web_xm~1.gif) ) to begin the export.

![](images/View_Config_Export_2_XML_1.jpg)
...
To Import a Configuration go to the Configurations Tab on the Main window, then click on the Paper World Icon on the Tool bar ( ![](images/web_xm~1.gif) ) to begin the import.

![](images/View_Config_SideList.jpg)

![](images/View_Config_Import_Form_Blank.jpg)

When the import Configuration from XML File form appears, click on the Select Button

![](images/View_Config_Import_Form_Select.jpg)

Browse to the location of the XML Configuration file

![](images/View_Config_Import_Form_Selected.jpg)

Once selected, Click on the Open Button to set

![](images/View_Config_Import_Form_Filled.jpg)

Now you are ready to Import the file to your collection.  So Click on the Import button to begin.

![](images/View_Config_Import_Form_Complete.jpg)
