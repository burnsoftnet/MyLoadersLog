...
Namespace ViewReports
    ...
    Public Class FrmReportConfigurationSheet
        ''' <summary>
        ...
        Private Sub frmReport_Configuration_Sheet_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            Call LoadData()
        End Sub
    End Class
End NameSpace