...
Public Class frmReport_DataLoader_RiflePistolWOC
    Public FID As Long
    ...
    Sub LoadData()
        ...
        End Try
    End Sub
    Private Sub frmReport_DataLoader_RiflePistolWOC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call LoadData()
    End Sub

    Private Sub frmReport_DataLoader_RiflePistolWOC_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Call DoFit()
    End Sub
End Class