...
Namespace Cyhper
    Friend Class CMD5
        ...
        Private Function ConvertToWordArray(ByRef sMessage As String) As Integer()
            ...
            'TODO: Test the Arry Clone that replaced the CopyArray
            'ConvertToWordArray = CopyArray(lWordArray)
    ...
    Public Class RegistrationProcess
        ...
        Private Const INSTALLONCEID_KEY As String = "WindowsSystemMarkerll"
...
#End Region
        ...
        Private Sub GetRegKeys(ByVal strRegPath As String, ByRef RegName As String, ByRef RegKey As String, ByRef ExpDate As String)
            ...
            If RegSubKeyExists(strValue) Then
                RegName = oD.DecryptSHA(GetRegSubKeyValue(strValue, FIELD_REGISTRATION_NAME, oD.EncryptSHA("Trial User")))
                RegKey = oD.DecryptSHA(GetRegSubKeyValue(strValue, FIELD_REGISTRATION_KEY, oD.EncryptSHA("")))
                ExpDate = oD.DecryptSHA(GetRegSubKeyValue(strValue, FIELD_REGISTRATION_EXPERATION, oD.EncryptSHA(MyDays)))
            Else
                If Not InstalledBefore_Exists() Then
        ...
        Public Sub JustSave(ByVal strRegPath As String, ByVal strName As String, ByVal strKey As String)
            Dim MyReg As RegistryKey
            Dim oE As New oEncrypt
            'MyReg = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(strRegPath, True)
        ...
        Private Sub SetInstalledBefore()
            Dim MyReg As RegistryKey
            Dim oE As New oEncrypt
            'MyReg = Microsoft.Win32.Registry.LocalMachine.CreateSubKey(INSTALLONCEID_PATH & "\\" & INSTALLONCEID_KEY)
            MyReg = Microsoft.Win32.Registry.CurrentUser.CreateSubKey(INSTALLONCEID_PATH & "\\" & INSTALLONCEID_KEY)
            'MyReg = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(INSTALLONCEID_PATH & "\\" & INSTALLONCEID_KEY, True)
        ...
        Public Sub DeleteInstalledBefore()
            ...
            'Call Microsoft.Win32.Registry.LocalMachine.DeleteSubKey(INSTALLONCEID_PATH & "\\" & INSTALLONCEID_KEY)
