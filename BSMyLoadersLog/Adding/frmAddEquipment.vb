    ...
    Public Class frmAddEquipment
        ...
        Sub AutoFill()
            Try
                ...
                'Dim ObjAF As New AutoFillCollections
                txtManu.AutoCompleteCustomSource = Equipment.Manufacturer(DatabasePath, errOut)
                If errOut.Length > 0 Then Throw New Exception(errOut)
                txtName.AutoCompleteCustomSource = Equipment.Name(DatabasePath, errOut)
                If errOut.Length > 0 Then Throw New Exception(errOut)
                txtUse.AutoCompleteCustomSource = Equipment.Use(DatabasePath, errOut)
                If errOut.Length > 0 Then Throw New Exception(errOut)
                txtPrice.AutoCompleteCustomSource = Equipment.Cost(DatabasePath, errOut)
                If errOut.Length > 0 Then Throw New Exception(errOut)
        ...
        Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
            Try
                ...
                If Not EquipmentInventory.Add(DatabasePath, strManu, strName, strUse, strPrice, 
                                              strNotes, errOut) Then Throw New Exception(errOut)
