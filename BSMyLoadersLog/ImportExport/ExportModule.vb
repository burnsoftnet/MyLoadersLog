...
' ReSharper restore RedundantAssignment
            ...
            Catch ex As Exception
                ...
                'Dim sMessage As String = strform & "." & strProcedure & "::" & Err.Number & "::" & ex.Message.ToString()
                'objFs.LogFile(MyLogFile, sMessage)
                Call LogError("ExportModule", "ExportExcel", Err.Number,
                              ex.Message.ToString)
            End Try
        End Sub
        ''' <summary>
        ...
        Public Sub ExportXml(ByVal table As DataTable, ByVal location As String)
            ...
            Catch ex As Exception
                ...
                'Dim sMessage As String = strform & "." & strProcedure & "::" & Err.Number & "::" & ex.Message.ToString()
                'objFs.LogFile(MyLogFile, sMessage)
                Call LogError("ExportModule", "ExportXML", Err.Number,
                              ex.Message.ToString)
            End Try
        End Sub
        ''' <summary>
        ...
        Public Sub ExportHtml(ByVal table As DataTable, ByVal location As String)
            ...
            Catch ex As Exception
                ...
                'Dim sMessage As String = strform & "." & strProcedure & "::" & Err.Number & "::" & ex.Message.ToString()
                'objFs.LogFile(MyLogFile, sMessage)
                Call LogError("ExportModule", "ExportHTML", Err.Number,
                              ex.Message.ToString)
            End Try
        End Sub
        ''' <summary>
...
' ReSharper disable RedundantAssignment
            ...
            Catch ex As Exception
                ...
                'Dim sMessage As String = strform & "." & strProcedure & "::" & Err.Number & "::" & ex.Message.ToString()
                'objFs.LogFile(MyLogFile, sMessage)
                Call LogError("ExportModule", "ExportText", Err.Number,
                              ex.Message.ToString)
            End Try
        End Sub
        ''' <summary>
        ...
        Public Sub ExportCsv(ByVal table As DataTable, ByVal location As String)
            ...
            Catch ex As Exception
                ...
                'Dim sMessage As String = strform & "." & strProcedure & "::" & Err.Number & "::" & ex.Message.ToString()
                'objFs.LogFile(MyLogFile, sMessage)
                Call LogError("ExportModule", "ExportCSV", Err.Number,
                              ex.Message.ToString)
            End Try
        End Sub
    End Module
