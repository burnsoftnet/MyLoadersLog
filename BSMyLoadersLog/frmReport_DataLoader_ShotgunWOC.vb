...
Public Class frmReport_DataLoader_ShotgunWOC
    Public FID As Long
    ...
    Sub LoadData()
        ...
        End Try
    End Sub
    Private Sub frmReport_DataLoader_ShotgunWOC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
