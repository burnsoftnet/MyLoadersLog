...
Public Class frmReport_Configuration_Sheet_SG
    ...
    Public Pro_ShotNo As String
    Public Pro_Material As String
    Public Pro_SelectedLoad As String
    ...
    Sub LoadData()
        Try
            ...
            parmList.Add(New ReportParameter("Pro_Material", Pro_Material))
            parmList.Add(New ReportParameter("Pro_ShotNo", Pro_ShotNo))
            parmList.Add(New ReportParameter("Pro_SelectedLoad", Pro_SelectedLoad))
        ...
        End Try
    End Sub
    Private Sub frmReport_Configuration_Sheet_SG_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call LoadData()
    End Sub
End Class