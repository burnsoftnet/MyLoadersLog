...
Partial Class frmReport_PrimerInventory
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReport_PrimerInventory))
        ...
        'ToolStripComboBox1
        '
        Me.ToolStripComboBox1.Items.AddRange(New Object() {"All Default", "All Manufacturer", "All Primer Type", "All Price", "All Qty", "Instock Manufacturer", "Instock Primer Type", "Instock Price", "Instock Qty", "Out-Of-Stock Manufacturer", "Out-Of-Stock Primer Type", "Out-Of-Stock Price", "Out-Of-Stock Qty"})
        Me.ToolStripComboBox1.Name = "ToolStripComboBox1"
        Me.ToolStripComboBox1.Size = New System.Drawing.Size(121, 25)
        Me.ToolStripComboBox1.Text = "All Default"
        '
        'ReportViewer1
        '
        Me.ReportViewer1.Dock = System.Windows.Forms.DockStyle.Fill
        ReportDataSource1.Name = "MLLDataSet_viewPrimerList"
        ReportDataSource1.Value = Me.viewPrimerListBindingSource
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource1)
        Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "BSMyLoadersLog.Report_PrimerInventory.rdlc"
        Me.ReportViewer1.Location = New System.Drawing.Point(0, 25)
        Me.ReportViewer1.Name = "ReportViewer1"
        Me.ReportViewer1.Size = New System.Drawing.Size(614, 278)
        ...
        Me.HelpProvider1.SetHelpKeyword(Me, "Primer Inventory")
        Me.HelpProvider1.SetHelpNavigator(Me, System.Windows.Forms.HelpNavigator.KeywordIndex)
        Me.HelpProvider1.SetHelpString(Me, "Primer Inventory")
        Me.Icon = CType(resources.GetObject("$this.Icon"), System.Drawing.Icon)
        Me.Name = "frmReport_PrimerInventory"
        Me.HelpProvider1.SetShowHelp(Me, True)
        Me.Text = "Primer Inventory Report"
