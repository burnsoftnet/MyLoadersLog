Imports BSMLL_HotFixes.BSFileSystem
Module ModGlobal
    ...
    Public Const ProductName = "My Loaders Log"
    ...
    Public Sub LogError(ByVal sForm As String, ByVal sProcedure As String, ByVal iErrNo As Long, ByVal sErrorDesc As String)
        ...
        End Try
    End Sub
    Public Sub DebugLog(ByVal sSub As String, Optional ByVal sMsg As String = "")
        Try
            If BUGGERME Then
                Dim ObjFS As New BSFileSystem
                Dim sMessage As String = sMsg & " from " & sSub
