...
![](images/Edit_Re-LoadedCalList_Menu.jpg)

![](images/Edit_Re-LoadedCalList_Before.jpg)
...
![](images/Edit_Re-LoadedCalList_After.jpg)
...
![](images/Edit_Re-LoadedCalList_Before_Delete.jpg)

Once the row is selected, just hit your Delete key to delete it from the database

![](images/Edit_Re-LoadedCalList_After_Delete.jpg)
...
![](images/Edit_Re-LoadedCalList_Before_Add.jpg)

Double click on the Blank column and type in what you wish to add to the list.

![](images/Edit_Re-LoadedCalList_Before_Add_Filled.jpg)
